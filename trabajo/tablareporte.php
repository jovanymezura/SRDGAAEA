...
<!-- **********************************************************************************************************************************************************
      ...
      *********************************************************************************************************************************************************** -->
      <!--header start-->
      <header id="cabecera" class="header black-bg">
              <div  class="sidebar-toggle-box">
                  <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
              </div>
            <!--logo start-->
            <a href="index.html" class="logo"><b>SRDGAEA</b></a>
            <!--logo end-->
...
<!--******PARTE DEL SIDEBAR MENU************-->
  <!--sidebar start-->
<!--  <aside>
    <div id="aside" class="nav-collapse">
      <!--sidebar menu start
         ...
         /*     ini_set('display_errors', 'off');
                 ...
                 error_reporting(0);
                  session_start();
                 echo $_SESSION['usuario']."<br>"."Ha iniciado Sesion";
...
<div>
	<fieldset>
        ...
        <div  class="row mt">
              ...
              <h4><i class="fa fa-angle-right"></i>Actividades Registradas:</h4>
                          <section  id="no-more-tables" >
                  
    	<?php
			include("conexionrepor.php");
			 $Con = new conexion();
			 $Con->recuperarDatos();
			  ?>
		</section>
